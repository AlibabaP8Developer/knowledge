...
| hostname                                                     | 查看主机名                            |
| host www.2021cn.top                                          | 解析主机名                            |
| nslookup www.2021cn.top                                      | 查询DNS记录，查看域名解 析是否正常    |
| ps -ef                                                       | 查看所有进程                          |
...
| grep BruceLee hello.txt       | 在⽂件hello.txt中查找关键词BruceLee     |
...
在文件中查找某个单词：命令行下 /关键字，回车

编辑/etc/profile文件，使用快捷键到底文档的最末行G和最首行gg
